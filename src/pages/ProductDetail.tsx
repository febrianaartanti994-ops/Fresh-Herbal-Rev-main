...
const ProductDetail = () => {
    ...
    return (
      <Layout>
        <div className="container-wide py-28 text-center">
          <h1 className="font-serif text-4xl mb-4">Produk Tidak Ditemukan</h1>
          ...
          >
            <Link to="/products">Cari semua produk</Link>
          </Button>
        </div>
      </Layout>
    );
  ...
  const handleWishlistToggle = () => {
    if (inWishlist) {
      ...
      toast({
        title: "Diapus dari Favorit",
        description: `${product.name} telah dihapus dari daftar favorit`,
      });
    } else {
      addToWishlist(product);
      toast({
        title: "Ditambahkan ke Favorit",
        description: `${product.name} berhasil ditambahkan ke favorit.`,
      });
    }
  };
  ...
  const handleAddToCart = () => {
    ...
    toast({
      ...
      description: `${quantity} × ${product.name} berhasil ditambahkan ke keranjang.`,
    });
    setQuantity(1);
  };
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  />
                  {inWishlist ? "Tersimpan di Favorit" : "Simpan ke Favorit"}
                </Button>
              </div>
              ...
              <div className="mt-10 pt-8 border-t border-border grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Pengeiriman ke Seluruh Indonesia
                  </p>
                </div>
                <div>
                  <p className="text-[11px] font-semibold tracking-[0.15em] uppercase text-muted-foreground/60 mb-1">
            ...
            <div className="flex items-end justify-between mb-12">
              <div>
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-foreground">
                  Produk Lain dari {collection?.name}
                </h2>
              </div>
              <Link
                to={`/products?collection=${collection?.slug}`}
