...
const sortOptions: { value: SortOption; label: string }[] = [
  ...
  { value: "name-asc", label: "Alfabet A-Z" },
];
...
const Products = () => {
  ...
  const currentCollection =
    activeCollection !== "all" ? getCollectionBySlug(activeCollection) : null;
        ...
        <div className="relative container-full h-full flex flex-col justify-end pb-12 md:pb-16">
          ...
          >
            <p className="text-[10px] font-semibold tracking-[0.3em] uppercase text-white/50 mb-3">
              {currentCollection ? "Kategori" : "Belanja"}
            </p>
            <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl text-white mb-3 leading-[0.95]">
              {currentCollection ? currentCollection.name : "Semua Produk"}
            </h1>
            {currentCollection && (
          ...
          {filteredAndSortedProducts.length > 0 ? (
            <>
              <div className="flex items-center justify-between mb-10">
                <p className="text-sm text-muted-foreground">
                  ...
                  {filteredAndSortedProducts.length === 1 ? "produk" : "produk"}
                </p>
              </div>
            ...
            <div className="text-center py-28">
              ...
              <p className="text-muted-foreground mb-8">
                Kategori ini sedang kami siapkan.
              </p>
              <Button
                asChild
                variant="outline"
